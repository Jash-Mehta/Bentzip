      ...
      children: [
        ...
        Expanded(
          child: GridView.count(
            ...
            crossAxisSpacing: Responsive.issmallmobile(context) ? 20 : 40,
            mainAxisSpacing: Responsive.issmallmobile(context) ? 20 : 30,
            crossAxisCount: 2,
            children: <Widget>[
              Container(
              ...
              /**
                   ...
                   */
              InkWell(
                onTap: () => Navigator.pushNamed(context, '/techerdashboard'),
                child: Container(
                  decoration: BoxDecoration(
                      color: Colors.blue[800],
                      borderRadius: BorderRadius.circular(10.0)),
